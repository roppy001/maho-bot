 ...
 * 指定された凸の予約が入る。
   ...
   * 1凸目の実績登録済みで、1凸目の持ち越しを持っていなくて、1凸目の予約をした場合は、入力エラーとなる
   * 1凸目の実績登録済みで、1凸目の持ち越しを持っていて、1凸目の持ち越しを予約済みでなくて、1凸目の予約をした場合は、1凸目の持ち越しの予約となる
   * 上記は2凸目以降も同等となる
 ...
 * 指定された凸の実績登録が行われる。実績登録がされるとともに、予約が以下のルールに従って削除される。
   ...
   * 1凸目の実績登録をした際に、同じ凸同じボスに実績登録があった場合、上書きされる
   * 上記は2凸目以降も同等となる
